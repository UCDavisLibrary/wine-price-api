...
-- for i in example/csv/*.csv; do dcpg psql -d wine_price -c "\COPY catalog_pages (filename,page,contents,thumbnail_png,ocr) from '/app/$i' with csv header"
...
insert into media (media_id,title,contents,thumbnail_png,ocr)
select
p.media_id,
